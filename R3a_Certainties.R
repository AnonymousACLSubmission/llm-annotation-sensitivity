...
ggsave("Plots/R/certainty_selfreport.pdf",
       last_plot(),
       device = cairo_pdf,     
...
ggsave("Plots/R/certainty_entropy.pdf", 
       last_plot(),
       device = cairo_pdf,     
       width  = 20,            # close to dina4
       height = 13,             
...
ggsave("Plots/R/certainty_disparity.pdf",
       last_plot(),
       device = cairo_pdf,     
       width  = 20,            # close to dina4
       height = 13,             
...
ggsave("Plots/R/certainty_correlations.pdf", 
       last_plot(),
       device = cairo_pdf,     
       width  = 20,            # close to dina4
       height = 13,             
